...
# ucf_integral <-  readOGR("data/UC/ucsfi.shp", verbose = FALSE)
# ucf_sustentavel <-  readOGR("data/UC/ucsfus.shp", verbose = FALSE)
...
### **Áreas de Concentração por estado**
...
### **Percentual de áreas com registros priorizado pelo Zonation na solução final (corte em 30%) para as espécies migratórias não oceânicas**
...
### **Espécies migratórias ameaçadas**
...
* [Sítios Ramsar](https://www.ramsar.org/) – informações sobre os sítios Ramsar ao redor do mundo.
